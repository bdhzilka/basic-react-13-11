...
import {
    DELETE_ARTICLE, ADD_COMMENT, LOAD_ALL_ARTICLES, LOAD_ARTICLE, LOAD_ARTICLE_COMMENTS, START, SUCCESS,
    LOAD_COMMENTS
} from '../constants'
...
export default (articles = new ReducerRecord(), action) => {
    ...
    switch (type) {
        ...
        case LOAD_ALL_ARTICLES + SUCCESS:
            return articles
                .set('loading', false)
                .set('entities', arrToImmutableMap(response, ArticleRecord).merge(articles.entities))
